...
export const API_ACTAS_EXPORT_FILTRO     = BASE_LIQUIDACION + 'acta/GetActaExportableResume';
export const API_ACTAS_EXPORT_DECLARADOS = BASE_LIQUIDACION + 'acta/GetActaDeclaradoExportable';
...
export const API_CERTIFICACION           = BASE_LIQUIDACION + 'Certificacion/certificacionListado';
