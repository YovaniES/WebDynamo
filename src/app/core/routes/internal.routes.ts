...
export const PERMISSION = {
  MENU_PERSONAS      : [ ROLES_ENUM.SUPER_ADMIN, ROLES_ENUM.ADMIN, ROLES_ENUM.CORD_TDP, ROLES_ENUM.LIDER, ROLES_ENUM.GESTOR],
  ...
  SUBMENU_VACACIONES : [ROLES_ENUM.SUPER_ADMIN, ROLES_ENUM.ADMIN, ROLES_ENUM.LIDER, ROLES_ENUM.CORD_TDP, ROLES_ENUM.GESTOR],
